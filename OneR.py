...
class OneR:
    ...
    def __init__(self, training_dataset) -> None:       
        ...
        # Crear un atributo para almacenar el nombre de la regla seleccionada
    ...
    def selectModel(self) -> None:
        ...
        selected_rule_index = self.total_errors['Result'].idxmin()  # Si es más de una regla, retornar la primera

        # Obtener el nombre del atributo cuya regla es la de menor error total
        self.selected_rule_name = self.total_errors.loc[selected_rule_index]['Attribute']
    ...
    def evaluate(self, test_dataset) -> None: 
        ...
        evaluations = pandas.DataFrame(result, columns=['Prediction', 'Match'])
